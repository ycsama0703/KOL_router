"""Phase69: PIT surface-text diagnostics at thr=0.60 for 2025-2026.
...
OUT_JSON = pathlib.Path(__file__).with_name("phase69_pit_surface_thr060_2025_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase69_pit_surface_thr060_2025_2026_table.md")
...
def main():
    ...
    result = {
        "task": "pit_surface_diagnostics_thr060_2025_2026",
        "protocol": {
