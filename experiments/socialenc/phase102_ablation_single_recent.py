...
def main():
    ...
    pathlib.Path(__file__).with_name("phase102_ablation_single_recent_result.json").write_text(json.dumps({"means": means, "comparisons": comps, "elapsed_sec": time.time() - t0}, indent=2))
