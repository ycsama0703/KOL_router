"""Phase70: PIT Qwen3-4B encoder benchmark at thr=0.60 for 2025-2026.
...
import phase68_pit_lightweight_thr060_2025_2026 as p61

OUT_JSON = pathlib.Path(__file__).with_name("phase70_pit_qwen3_4b_thr060_2025_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase70_pit_qwen3_4b_thr060_2025_2026_table.md")
...
def main():
    ...
    comparisons = {}
    phase61_path = pathlib.Path(__file__).with_name("phase68_pit_lightweight_thr060_2025_2026_result.json")
    ...
    result = {
        "task": "pit_qwen3_4b_origin_text_thr060_2025_2026",
        "protocol": {
