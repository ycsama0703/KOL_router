"""Phase66: PIT surface-text diagnostics for the 2025-2026 final test.
...
OUT_JSON = pathlib.Path(__file__).with_name("phase66_pit_surface_2025_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase66_pit_surface_2025_2026_table.md")
...
def main():
    ...
    result = {
        "task": "pit_surface_diagnostics_2025_2026",
        "protocol": {
