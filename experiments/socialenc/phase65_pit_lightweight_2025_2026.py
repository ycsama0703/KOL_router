"""Phase65: PIT lightweight main + ablation test on the recent 2025-2026 window.
...
OUT_JSON = pathlib.Path(__file__).with_name("phase65_pit_lightweight_2025_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase65_pit_lightweight_2025_2026_table.md")
...
def main():
    ...
    result = {
        "task": "pit_lightweight_main_ablation_2025_2026",
        "protocol": {
