"""Phase62: PIT Qwen3-4B encoder benchmark for the 2024-2026 final test.
...
OUT_JSON = pathlib.Path(__file__).with_name("phase62_pit_qwen3_4b_2024_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase62_pit_qwen3_4b_2024_2026_table.md")
...
def main():
    ...
    comparisons = {}
    phase61_path = pathlib.Path(__file__).with_name("phase61_pit_lightweight_2024_2026_result.json")
    ...
    result = {
        "task": "pit_qwen3_4b_origin_text_2024_2026",
        "protocol": {
            "train": [p61.TRAIN_START, p61.TRAIN_END],
            "validation": [p61.TRAIN_END, p61.VAL_END],
            "test": [p61.VAL_END, p61.TEST_END],
            "test_blocks": {
                "test_2024_2025": [p61.VAL_END, p61.TEST_MID],
                "test_2025_2026": [p61.TEST_MID, p61.TEST_END],
            },
