...
def main():
    ...
    pathlib.Path(__file__).with_name("phase99_graph_single_2566_result.json").write_text(json.dumps({"means": means, "comparisons": comps, "elapsed_sec": time.time() - t0}, indent=2))
