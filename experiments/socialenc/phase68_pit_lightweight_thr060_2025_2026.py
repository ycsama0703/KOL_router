"""Phase68: PIT lightweight main + ablation test at thr=0.60 on 2025-2026.
...
Protocol:
  ...
  - Train:      2022-06-01 <= day < 2024-06-01
  - Validation: 2024-06-01 <= day < 2025-06-01
...
estimated only from data before that block starts:
  ...
  - validation rows use history before 2024-06-01
...
OUT_JSON = pathlib.Path(__file__).with_name("phase68_pit_lightweight_thr060_2025_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase68_pit_lightweight_thr060_2025_2026_table.md")
...
def compute_block_state(rows_by, emb_by, all_rows):
    states = {}
    for block in ["train_2022_2023", "train_2023_2024", "val", "test_2025_2026"]:
...
def main():
    ...
    result = {
        "task": "pit_lightweight_main_ablation_thr060_2025_2026",
        "protocol": {
            ...
            "train_blocks": {
                ...
                "train_2023_2024": [TRAIN_MID, TRAIN_END],
            },
            "validation_blocks": {
