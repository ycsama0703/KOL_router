"""Phase73: PIT no-validation surface diagnostics at thr=0.55 for 2025-2026.
...
OUT_JSON = pathlib.Path(__file__).with_name("phase73_pit_noval_surface_thr055_2025_2026_result.json")
OUT_MD = pathlib.Path(__file__).with_name("phase73_pit_noval_surface_thr055_2025_2026_table.md")
...
def main():
    ...
    result = {
        "task": "pit_noval_surface_diagnostics_thr055_2025_2026",
        "protocol": {
